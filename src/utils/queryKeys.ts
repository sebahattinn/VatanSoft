...
export const exerciseKeys = {
  ...
  list: (params?: PaginationParams) =>
    [...exerciseKeys.all, { ...params }] as const,
  detail: (id: string) => [...exerciseKeys.all, "detail", id] as const,
  bodyParts: (params?: PaginationParams) =>
    [...exerciseKeys.all, "bodyParts", { ...params }] as const,
  equipment: (params?: PaginationParams) =>
    [...exerciseKeys.all, "equipment", { ...params }] as const,
  targets: (params?: PaginationParams) =>
    [...exerciseKeys.all, "targets", { ...params }] as const,
  byBodyPart: (bodyPart: string, params?: PaginationParams) =>
    [...exerciseKeys.all, "byBodyPart", bodyPart, { ...params }] as const,
  byEquipment: (equipment: string, params?: PaginationParams) =>
    [...exerciseKeys.all, "byEquipment", equipment, { ...params }] as const,
  byTarget: (target: string, params?: PaginationParams) =>
    [...exerciseKeys.all, "byTarget", target, { ...params }] as const,
  byName: (name: string, params?: PaginationParams) =>
    [...exerciseKeys.all, "byName", name, { ...params }] as const,
};
